...
type Querier interface {
	...
	GetRevenueReport(ctx context.Context, arg GetRevenueReportParams) (int64, error)
	...
	ListProductsSoldReport(ctx context.Context, arg ListProductsSoldReportParams) ([]ListProductsSoldReportRow, error)
